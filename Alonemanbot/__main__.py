...
from Alonemanbot.modules import ALL_MODULES
from Alonemanbot.modules.helper_funcs.chat_status import is_user_admin
from Alonemanbot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Alonemanbot.modules." + module_name)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/shiinobu/Alonemanbot"),
                 ],
                 [
