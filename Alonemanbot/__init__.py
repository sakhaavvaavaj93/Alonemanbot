...
def get_user_list(__init__, key):
    with open("{}/Alonemanbot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Alonemanbot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[Alonemanbot]')
...
if ENV:
    ...
    from Alonemanbot.config import Development as Config
...
from Alonemanbot.modules.helper_funcs.handlers import (
