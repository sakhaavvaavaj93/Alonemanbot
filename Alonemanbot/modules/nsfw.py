...
from Alonemanbot import dispatcher, updater
import Alonemanbot.modules.sql.nsfw_sql as sql
from Alonemanbot.modules.log_channel import gloggable
...
def add_nsfw(update: Update, context: CallbackContext):
    ...
    if not is_nsfw:
        ...
        msg.reply_text("ഇനി വൃത്തികേട് കാണിക്കുന്നവനെ പൊക്കി പുറത്തിടും.!")
        message = (
