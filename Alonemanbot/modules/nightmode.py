import os
from Alonemanbot.modules.sql.night_mode_sql import (
    add_nightmode,
    rmnightmode,
    get_all_chat_id,
    is_nightmode_indb,
...
from Alonemanbot import telethn as tbot, OWNER_ID
    ...
    for pro in chats:
        try:
            await tbot.send_message(
              int(pro.chat_id), "**🌒 START NIGHT MODE**\n❌ From this time up to 6 all users will not be able to send media (text,photos, videos, files .) and links in the group.\n**Don't allow speak on vc during 12am to 6 am.**\n**Poweredb**\n**@Steanzle_MariaGbot**"
            )
            await tbot(
